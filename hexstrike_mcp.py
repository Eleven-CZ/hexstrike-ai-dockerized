...
DEFAULT_HEXSTRIKE_SERVER = "http://127.0.0.1:8899"  # Default HexStrike server URL
...
def parse_args():
    ...
    parser.add_argument("--transport", type=str, default="sse",
                      ...
                      help="MCP transport mode: stdio, sse, or streamable-http (default: sse)")
    parser.add_argument("--host", type=str, default="0.0.0.0",
                      help="Host to bind for SSE/streamable-http transport (default: 0.0.0.0)")
    parser.add_argument("--port", type=int, default=9010,
                      help="Port for SSE/streamable-http transport (default: 9010)")
...
def main():
    ...
    try:
        ...
        if args.transport == "stdio":
            logger.info("🚀 Starting HexStrike AI MCP server (stdio mode)")
